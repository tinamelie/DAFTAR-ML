...
from daftar.viz.colors import (CONFUSION_MATRIX_CMAP, CONFUSION_MATRIX_LINEWIDTH, CONFUSION_MATRIX_LINECOLOR,
                          CLASSIFICATION_BAR_BG_COLOR, CLASSIFICATION_BAR_COLOR)
...
def generate_confusion_matrix(true_values, predictions, output_path, title="Confusion Matrix", metric=None):
    ...
    if metric is not None:
        ...
        # Use standard colors from colors module (imported at the top)
        plt.figtext(0.02, 0.02, metric_text, fontsize=14, 
                    bbox={"facecolor": "white", "alpha": 0.9, "pad": 10, "edgecolor": CLASSIFICATION_BAR_BG_COLOR})
